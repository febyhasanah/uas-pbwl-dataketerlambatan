...
<body>
    <div class="row justify-content-center">
        <div class="col-md-auto">
            <br><br>
            <h4><center> <b> REKAP DATA KETERLAMBATAN SISWA SMAN 1 TANJUNG MORAWA</b>
    ...
    <br> 
      <span style="padding: 100px"> Mengetahui </span> <br>
        <span style="padding: 100px"> Kepala Sekolah SMAN 1 TANJUNG MORAWA<br><br> <br> <br>
            <strong style="padding: 100px"><u>FEBY HASANAH RITONGA</u></strong>
</body>
</html>