...
<head>
    ...
    <title>{{ ('SMAN 1 TANJUNG MORAWA') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-info shadow-lg">
            <div class="container" style="height: 60px!important;">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    {{ ('SMAN 1 TANJUNG MORAWA') }} <a href="/siswa" class="navbar-brand">DATA SISWA</a> <a href="/guru" class="navbar-brand">DATA GURU PIKET</a> <a href="/terlambat" class="navbar-brand">DATA KETERLAMBATAN</a>
                </a>
